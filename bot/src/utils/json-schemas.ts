...
const sessionBlueprintSchema: Schema = {
	...
	properties: {
		...
		category: { enum: ["parkour", "pvp", "pve", "puzzle", "stategy", "hns", "ctm", "multiple", "other", "adventure", "survival", "horror", "sandbox", "creation", "tabletop", "race", "minigame", "social-deduction"] },
